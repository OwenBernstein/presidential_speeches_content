...
pop_reg <- dwplot(populism_regression, show_intercept = T, conf.level = .95) %>%
...
img_reg <- dwplot(immigration_regression, show_intercept = T, conf.level = .95) %>%
  relabel_predictors("(Intercept)" = "Barack Obama as Baseline",
                     "speakerBernie Sanders" = "Bernie Sanders",
                     "speakerDonald Trump" = "Donald Trump",
                     "speakerHilary Clinton" = "Hilary Clinton",
...
env_reg <- dwplot(environment_regression, show_intercept = T, conf.level = .95) %>%
  relabel_predictors("(Intercept)" = "Barack Obama as Baseline",
                     "speakerBernie Sanders" = "Bernie Sanders",
                     "speakerDonald Trump" = "Donald Trump",
                     "speakerHilary Clinton" = "Hilary Clinton",
...
pro_reg <- dwplot(progressive_regression, show_intercept = T, conf.level = .95) %>%
  relabel_predictors("(Intercept)" = "Barack Obama as Baseline",
                     "speakerBernie Sanders" = "Bernie Sanders",
                     "speakerDonald Trump" = "Donald Trump",
                     "speakerHilary Clinton" = "Hilary Clinton",
...
con_reg <- dwplot(conservatism_regression, show_intercept = T, conf.level = .95) %>%
  relabel_predictors("(Intercept)" = "Barack Obama as Baseline",
                     "speakerBernie Sanders" = "Bernie Sanders",
                     "speakerDonald Trump" = "Donald Trump",
                     "speakerHilary Clinton" = "Hilary Clinton",
