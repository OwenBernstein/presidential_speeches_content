...
conservatism <- tidy_speeches %>% 
  group_by(speaker, title, region, total_words, date) %>% 
  filter(str_detect(word, "belief") | str_detect(word, "family")
...
pop_reg <- dwplot(populism_regression, show_intercept = T, conf.level = .90) %>%
...
img_reg <- dwplot(immigration_regression, show_intercept = T, conf.level = .90) %>%
  relabel_predictors("(Intercept)" = "Barack Obama as Baseline",
                     "speakerBernie Sanders" = "Bernie Sanders",
                     "speakerDonald Trump" = "Donald Trump",
                     "speakerHilary Clinton" = "Hilary Clinton",
...
env_reg <- dwplot(environment_regression, show_intercept = T, conf.level = .90) %>%
  relabel_predictors("(Intercept)" = "Barack Obama as Baseline",
                     "speakerBernie Sanders" = "Bernie Sanders",
                     "speakerDonald Trump" = "Donald Trump",
                     "speakerHilary Clinton" = "Hilary Clinton",
...
pro_reg <- dwplot(progressive_regression, show_intercept = T, conf.level = .90) %>%
  relabel_predictors("(Intercept)" = "Barack Obama as Baseline",
                     "speakerBernie Sanders" = "Bernie Sanders",
                     "speakerDonald Trump" = "Donald Trump",
                     "speakerHilary Clinton" = "Hilary Clinton",
...
conservatism_regression <- lm(conservatism_percent ~ speaker, sentiment_speeches)

con_reg <- dwplot(conservatism_regression, show_intercept = T, conf.level = .90) %>%
  relabel_predictors("(Intercept)" = "Barack Obama as Baseline",
                     "speakerBernie Sanders" = "Bernie Sanders",
                     "speakerDonald Trump" = "Donald Trump",
                     "speakerHilary Clinton" = "Hilary Clinton",
